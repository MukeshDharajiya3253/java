            ...
            <section id="content">
                <div class="container">
                    ...
                    <div class="card animated ">
                        ...
                        <a href="#prev" class="button"><i class="zmdi zmdi-chevron-left"></i></a></li>
                        ...
                        <a href="#next" class="button"><i class="zmdi zmdi-chevron-right"></i></a></li>
                        <li class="last disabled" aria-disabled="true">
                        <a href="#last" class="button">
                        <i class="zmdi zmdi-more-horiz"><i></i></i></a></li></ul></div>
                        <div class="col-sm-6 infoBar"><div class="infos">Showing 1 to 5 of 5 entries</div>
                        </div>
                        </div>
                        </div>
                    </div>
