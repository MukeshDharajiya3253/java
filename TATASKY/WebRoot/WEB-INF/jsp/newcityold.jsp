...
<head>
   ...
   <link href="vendors/bower_components/bootstrap-select/dist/css/bootstrap-select.css" rel="stylesheet">
		...
		function f1(stateid,cityname)
		{
			//$("#add_record").modal('show');
			//$("#addcityform #cityname").val(cityname);
			document.getElementById("cityname").value=""+cityname;
			document.getElementById("stateid").value=stateid;
			
			document.searchform.action="statemaster_update";
			document.searchform.submit();
                            ...
                            <table class="table table-striped table-condensed">
                                ...
                                <s:forEach var="row" items="${DispList}">
                                    <tr>
										...
										<td>
											<a href="#" title="Edit Record" class="btn btn-default waves-effect " onclick="f1('${row[0]}','${row[1]}');"><i class="zmdi zmdi-edit"></i></a>	&nbsp;
...
<div class="modal fade" id="add_record" tabindex="-1" role="dialog" aria-hidden="true">
                                ...
                                <div class="form-group fg-line">
                                   ...
                                   <select class="selectpicker" data-live-search="true" name="stateid" id="statename">
                                ...
                                <div class="form-group fg-line">
                                    ...
                                    <input type="text" name="cityname" class="form-control input-sm" id="cityname" placeholder="Enter City">
                                </div>
                                 <div class="checkbox">
                                    <label>
