...
public class GstinActionBin extends DAO {
	...
	public List<?> getCSCityList; // get list Country State And City
	public List<?> getCSCityList1; // get list  State And City
	public List<?> getCSCityList2;
	public List<?> getCSCityList3;
	...
	public List<?> getGetCSCityList() {
		return getCSCityList;
	}
	public void setGetCSCityList(List<?> getCSCityList) {
		this.getCSCityList = getCSCityList;
	}
	public List<?> getGetCSCityList1() {
		return getCSCityList1;
	}
	public void setGetCSCityList1(List<?> getCSCityList1) {
		this.getCSCityList1 = getCSCityList1;
	}
	public List<?> getGetCSCityList2() {
		return getCSCityList2;
	}
	public void setGetCSCityList2(List<?> getCSCityList2) {
		this.getCSCityList2 = getCSCityList2;
	}
	public List<?> getGetCSCityList3() {
		return getCSCityList3;
	}
	public void setGetCSCityList3(List<?> getCSCityList3) {
		this.getCSCityList3 = getCSCityList3;
	}
