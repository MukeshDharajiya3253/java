...
style="overflow: hidden;"><head>
		...
		function validation()
		{
			...
			{
			sweetAlert
			("OPPS...","Gstin Name Empty or Less 7 Charecter", "error");
			...
			//sweetAlert("Oops...", ".Gstin Name is Empty Or Size Less 7 Character!", "error"); 
			...
			{
			sweetAlert
			("OPPS...","Gstin Name Contain Only alphabet", "error");
			...
			sweetAlert
			("OPPS...","Please Enter Two Digite State Code", "error");
			...
			sweetAlert
			("OPPS...","Please Enter 10 Digite PanNumber", "error");
			...
			sweetAlert
			("OPPS..."," Please Enter 3 Digite Random Number", "error");
			...
			sweetAlert
			("OPPS...","  Please Enter Valid Address1", "error");
			...
			{
					sweetAlert
			("OPPS...","  Please Enter Valid Address2", "error");
			...
			{
				sweetAlert
			("OPPS...","  Please Enter Valid Address3", "error");
			...
			{
				sweetAlert
				("OPPS..."," Opps Please Select Country", "error");
			...
			else if(stateid.length=="")
			{
				...
				sweetAlert
				("OPPS...","Opps Please Select STATE", "error");
			...
			else if(cityid.length=="" )
			{
				...
				sweetAlert
				("OPPS...","Opps Please Select CITY", "error");
			...
			{
				sweetAlert
				("OPPS...","Opps Please Enter 6 Digite Pincode Number", "error");			
...
function add(gstinid)
	
	{
		...
		if(flage!=false)
		{
				...
				{
					document.getElementById("gstinid").value=gstinid;
					document.myform.action="gstin_updateUser";
					document.myform.submit();
				}
