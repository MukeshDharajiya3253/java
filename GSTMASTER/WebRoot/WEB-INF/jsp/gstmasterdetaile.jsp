...
<html style="overflow: hidden;"><head>
        ...
        <link href="vendors/bower_components/material-design-iconic-font/dist/css/material-design-iconic-font.min.css" rel="stylesheet">
         <link href="vendors/bower_components/datatable/datatable.css" rel="stylesheet">
         <script src="vendors/bower_components/datatable/datatable.js"></script>
		...
		function gett()
		{
		var dataSet=["asd","asd","asd","asd","asd","add"];
            ...
            <section id="content">
                ...
                <h2>Client Brand GSTN</h2>
                 ...
                 <table class="table table-bordered" style="text-align:center;" >
                    <tr>
                        <td><a href="gstin_getListASC">&nabla;</a><a href="gstin_getListDESC">&Delta;</a>GSTIN ID</td>
                        <td>GSTIN NAME</td>
                        <td>GSTI NO</td>
                        <td>ADDRESS</td>
                        <td>PINCODE</td>
